/*
 * Course: CS216-00x
 * Project: Lab5 Patch(to provide testing which was missed in Lab5)
 ...
 *          Compare to Lab5, the input file format has been changed:
 *          (in Lab5) actorName, movie1, movie2, ... , movieN
 *          (in Lab5Patch) movieTitle, actor1, actor2, ... , actorM
 * Author: (your name)
 */
